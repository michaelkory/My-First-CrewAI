...
workshop_date = '8/14/24'
workshop_url = None
# sometimes the URL is not on the workshop page, lame
workshop_url = 'https://events.redhat.com/profile/1085129'
...
# Create Tasks
summarize_workshop_task = tasks.summarize_workshop_task(jr_summarizer_agent, workshop_date, workshop_url)
...
summarize_rh_summit_blog_task = tasks.summarize_rh_summit_blog_task(jr_summarizer_agent, workshop_date)
copywrite_rh_summit_blog_task = tasks.copywrite_rh_summit_blog_task(sr_copywriter_agent)

summarize_rh_summit_video_task = tasks.summarize_rh_summit_video_task(jr_summarizer_agent, workshop_date)
copywrite_rh_summit_video_task = tasks.copywrite_rh_summit_video_task(sr_copywriter_agent)

summarize_ansible_blog_task = tasks.summarize_blog_from_feed_task(
...
copywrite_ansible_video_task = tasks.copywrite_video_from_feed_task(
    sr_copywriter_agent, "Ansible", "ansible_video")

summarize_openshift_video_task = tasks.summarize_video_from_feed_task(
...
copywrite_openshift_video_task = tasks.copywrite_video_from_feed_task(
    sr_copywriter_agent, "Red Hat Openshift", "openshift_video")

summarize_rhel_video_task = tasks.summarize_video_from_feed_task(
...
copywrite_rhel_video_task = tasks.copywrite_video_from_feed_task(
...
crew = Crew(
    ...
    tasks=[
        ...
        summarize_rh_summit_blog_task,
        copywrite_rh_summit_blog_task,
        summarize_rh_summit_video_task,
        copywrite_rh_summit_video_task,
